<?php 
    ...
    $postsParams = ['order'=>'asc'];
    $postsParams['search'] = urlencode($_GET['search-input']);
    ...
    $posts_posts = $sdk->query("posts", "", "GET", 1, 99, $postsParams);
    $posts_ciclo = $sdk->query("cinescuela-ciclo", "", "GET", 1, 99, $postsParams);
    $posts_movies = $sdk->query("cinescuela-movies", "", "GET", 1, 99, $postsParams);
